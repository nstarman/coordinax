...
@dispatch.multi(
    # Positions
    (type[CartesianPos1D], type[CartesianPos1D], ParamsDict),
    (type[RadialPos], type[RadialPos], ParamsDict),
    # Velocities
    (type[CartesianVel1D], type[CartesianVel1D], ParamsDict),
    (type[RadialVel], type[RadialVel], ParamsDict),
    # Accelerations
    (type[CartesianAcc1D], type[CartesianAcc1D], ParamsDict),
    (type[RadialAcc], type[RadialAcc], ParamsDict),
)
def vconvert_impl(
