...
from .api import AuxDict, OptAuxDict, OptUSys, ParamsDict
...
def vconvert_parse_input(
    params: ParamsDict, dims: DimsDict, usys: OptUSys, /
) -> ParamsDict:
...
def combine_aux(in_aux: OptAuxDict, out_aux: OptAuxDict, /) -> AuxDict:
